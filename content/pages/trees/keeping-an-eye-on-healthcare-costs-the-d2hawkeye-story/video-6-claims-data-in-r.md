...
*   [<Quick Question]({{< baseurl >}}/pages/trees/keeping-an-eye-on-healthcare-costs-the-d2hawkeye-story/quick-question-337)
...
*   [\>Quick Question]({{< baseurl >}}/pages/trees/keeping-an-eye-on-healthcare-costs-the-d2hawkeye-story/quick-question-342)

Video 6: Claims Data in R
-------------------------

In the next few videos, we'll be using the dataset [ClaimsData (ZIP - 2.2MB)]({{< baseurl >}}/resources/claimsdata-csv): this file contains 1 CSV file. Please download the dataset to follow along. Note that this file is in ZIP format due to its large size. You will need to decompress (or unzip) the file before loading it into R.
...
An R script file with all of the R commands used in this lecture can be downloaded here: [Unit4\_D2Hawkeye (R)]({{< baseurl >}}/resources/unit4_d2hawkeye)

{{< resource 02abace9-66ce-4574-f235-413cc9324cb9 >}}

*   [BackQuick Question]({{< baseurl >}}/pages/trees/keeping-an-eye-on-healthcare-costs-the-d2hawkeye-story/quick-question-337)
*   [ContinueQuick Question]({{< baseurl >}}/pages/trees/keeping-an-eye-on-healthcare-costs-the-d2hawkeye-story/quick-question-342)