...
The slides from all videos in this Lecture Sequence can be downloaded here: [The D2Hawkeye Story (PDF - 1.3MB)]({{< baseurl >}}/resources/mit15_071s17_unit4_d2hawkeye).

*   [BackVideo 7: The Model v. The Experts]({{< baseurl >}}/pages/trees/judge-jury-and-classifier-an-introduction-to-trees/video-7-the-model-v-the-experts)
*   [ContinueQuick Question]({{< baseurl >}}/pages/trees/keeping-an-eye-on-healthcare-costs-the-d2hawkeye-story/quick-question-311)