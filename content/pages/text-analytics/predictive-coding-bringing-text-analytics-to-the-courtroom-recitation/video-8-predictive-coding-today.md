...
*   [BackVideo 7: The ROC Curve]({{< baseurl >}}/pages/text-analytics/predictive-coding-bringing-text-analytics-to-the-courtroom-recitation/video-7-the-roc-curve)
*   [ContinueAssignment 5]({{< baseurl >}}/pages/text-analytics/assignment-5)